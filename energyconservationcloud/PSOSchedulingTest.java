package energyconservationcloud;
...
//                      List<Cloudlet> newList = PlanetLabHelper.createCloudletListPlanetLab(brokerId, inputFolder);
	...
	static void CreateNetwork(int numhost, NetworkDatacenter dc) {
       ...
       public static  void powerhost(String inp)
       {
           String experimentName = "PSO";
		String outputFolder = "output";
		String inputFolder =inp;
		...
		try {
			...
			datacenter.setDisableMigrations(false); // VM migration  enabled false/true 
